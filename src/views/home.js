    ...
    <div className="home-container">
        ...
        >
          ...
          <div data-thq="thq-navbar-nav" className="home-desktop-menu">
            <nav className="home-links">
              ...
              <span className="home-nav22 bodySmall">Quiz</span>
          ...
          >
            <div className="home-nav">
              ...
              <nav className="home-links1">
                ...
                <span className="home-nav221 bodySmall">Quiz</span>
        ...
        <div className="heroContainer home-hero1">
          <div className="home-container01">
            ...
            <span className="home-hero-sub-heading bodyLarge">
              <span>
                <span>
                  <span>Test your skills with our fun quiz!</span>
                  <span>
                    <span
            ...
            <div className="home-btn-group">
              <button className="buttonFilled">Begin Quiz</button>
          ...
          <div className="home-features1">
            <div className="home-container02">
              ...
              <h2 className="home-features-heading heading2">
                Exciting Features of Our Quiz Platform
              </h2>
              <span className="home-features-sub-heading bodyLarge">
                <span>
                  <span>
                    <span>
                      Discover what makes our quiz experience unique and
                      enjoyable
                    </span>
                    <span>
                      <span
            ...
            <div className="home-container03">
              <FeatureCard
                ...
                subHeading="Enjoy interactive quizzes with a variety of fun questions"
              ></FeatureCard>
              <FeatureCard
                heading="Multiple Choice Answers"
                subHeading="Select from four options for each question to test your knowledge"
              ></FeatureCard>
              <FeatureCard
                heading="User-Friendly Interface"
                subHeading="Navigate through the quiz easily with a simple and intuitive design"
              ></FeatureCard>
              <FeatureCard
                heading="Instant Results"
                subHeading="Receive immediate feedback on your quiz performance upon completion"
              ></FeatureCard>
            </div>
          </div>
        </div>
          ...
          <div className="home-container05">
            <div className="freePricingCard home-pricing-card">
              <div className="home-container06">
                ...
                <span className="bodySmall">Access to basic quiz features</span>
              </div>
              ...
              <div className="home-container08">
                <div className="home-container09">
                  ...
                  <span className="bodySmall">5 questions quiz</span>
                </div>
                <div className="home-container10">
                  <span className="home-text41">✔</span>
                  <span className="bodySmall">Basic quiz analytics</span>
                </div>
                <div className="home-container11">
                  <span className="home-text42">✔</span>
                  <span className="bodySmall">Customizable quiz design</span>
                </div>
                <div className="home-container12">
                  <span className="home-text43">✔</span>
                  <span className="bodySmall">Shareable quiz results</span>
                </div>
              </div>
            ...
            <div className="basicPricingCard home-pricing-card1">
              <div className="home-container13">
                ...
                <span className="bodySmall">
                  Enhanced quiz experience for individuals
                </span>
              </div>
              ...
              <div className="home-container15">
                ...
                <div className="home-container17">
                  ...
                  <span className="bodySmall">10 questions quiz</span>
                </div>
                <div className="home-container18">
                  <span className="home-text52">✔</span>
                  <span className="bodySmall">Advanced quiz analytics</span>
                </div>
                <div className="home-container19">
                  <span className="home-text53">✔</span>
                  <span className="bodySmall">Customizable result pages</span>
                </div>
                <div className="home-container20">
                  <span className="home-text54">✔</span>
                  <span className="bodySmall">No ads during quiz</span>
                </div>
              </div>
            ...
            <div className="proPricingCard home-pricing-card2">
              <div className="home-container21">
                ...
                <span className="bodySmall">
                  Premium quiz features for professionals
                </span>
              </div>
              ...
              <div className="home-container23">
                ...
                <div className="home-container27">
                  ...
                  <span className="bodySmall">Custom branding options</span>
                </div>
      ...
      <div className="home-banner">
        <div className="bannerContainer home-banner1">
            ...
            <span>
              <span>
                <span>
                  ...
                  Answer five questions and see how well you score. Are you
          ...
          <button className="buttonFilled">Start Quiz</button>
        </div>
      </div>
        ...
        <div className="faqContainer">
          <div className="home-faq1">
            ...
            <div className="home-container30">
              <Question1
                answer="There are a total of 5 questions in the quiz."
                question="How many questions are in the quiz?"
              ></Question1>
              <Question1
                answer="Each question has 4 possible answers to choose from."
                question="How many answers are there for each question?"
              ></Question1>
              <Question1
                answer="Yes, you can retake the quiz as many times as you like."
                question="Can I retake the quiz?"
              ></Question1>
              <Question1
                answer="There is no time limit for completing the quiz."
                question="Is there a time limit for completing the quiz?"
              ></Question1>
              <Question1
                answer="Your quiz results will be displayed at the end of the quiz."
                question="How will I know my quiz results?"
              ></Question1>
            </div>
          </div>
        </div>
        ...
        <footer className="footerContainer home-footer1">
          <div className="home-container31">
            ...
            <nav className="home-nav1">
              <span className="bodySmall">Home</span>
              <span className="home-nav222 bodySmall">Quiz</span>
